...
/>
      ...
      I am a fresh front-End Web Developer,excel to create a website with complete clean 
      code along with interactive animation and responsiveness accessible to all users.
      </p>
